...
- **Type** — three families, one job each. **Instrument Serif** only for the masthead and edition date. **Newsreader** for every headline and all reading text. **IBM Plex Mono** for anything that is metadata: navigation, kickers, timestamps, counts, captions. Metadata is uppercase and widely tracked; reading text never is.
